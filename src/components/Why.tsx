const items = [
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M9 2L10.8 6.3H15.5L11.7 8.9L13.2 13.2L9 10.6L4.8 13.2L6.3 8.9L2.5 6.3H7.2L9 2Z"
          stroke="currentColor"
          strokeWidth="1.3"
    ...
    desc: "Do alinhamento à primeira entrega com agilidade. Sem processos desnecessários.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M2.5 9C2.5 5.4 5.4 2.5 9 2.5C12.6 2.5 15.5 5.4 15.5 9"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
        />
        <path
          d="M15.5 9C15.5 12.6 12.6 15.5 9 15.5"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
    ...
    desc: "A entrega é o começo, não o fim. Suporte e evolução contínuos conforme o negócio cresce.",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          d="M3.5 12.5L7 9L9.5 11.5L13.5 7"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    desc: "Cada decisão técnica tem justificativa de negócio. Desenvolvemos para resolver problemas.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 py-28">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {items.map((item) => (
            <div
              key={item.title}
              className="p-7 rounded-2xl card-hover reveal"
              style={{
