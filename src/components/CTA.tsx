  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 50%, rgba(0,196,122,0.12) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(255,255,255,0.04) 0%, transparent 40%)",
        }}
      />
      <div
        className="absolute inset-0 hero-grid pointer-events-none opacity-20"
        aria-hidden="true"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-28 text-center">
        ...
        <p
          className="text-xs font-semibold tracking-widest uppercase mb-5 reveal"
          style={{ color: "rgba(0,196,122,0.9)" }}
        >
          Inicie uma conversa
        </p>
        <h2
        ...
        >
          Pronto para elevar
          <br />o seu <span style={{ color: "#00C47A" }}>padrão digital?</span>
        </h2>
        <p
          className="font-light leading-relaxed max-w-md mx-auto mb-12 reveal"
