const services = [
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M6 6H9M11 6H14M6 10H9M11 10H14M6 14H9"
          stroke="currentColor"
          strokeWidth="1.4"
          strokeLinecap="round"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {services.map((svc) => (
            ...
            >
              ...
              {/* Subtle accent glow */}
              <div
                className="absolute top-0 left-0 right-0 h-24 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                style={{
                  background: `linear-gradient(to bottom, ${svc.accentBg}, transparent)`,
                }}
                aria-hidden="true"
              />
