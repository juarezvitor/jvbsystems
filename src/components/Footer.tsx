      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-12">
          ...
          <div className="max-w-xs">
            ...
            >
              Automações &amp; Desenvolvimento Web para negócios que querem
              crescer com propósito e tecnologia de alto padrão.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-xs" style={{ color: "rgba(107,130,120,0.6)" }}>
            Tecnologia desenvolvida com propósito, entregue com
            responsabilidade.
          </p>
        </div>
      </div>
